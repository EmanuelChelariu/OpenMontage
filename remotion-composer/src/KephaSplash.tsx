...
// ---------------------------------------------------------------------------
// KephaSplash — choreographed launch animation for the Kepha app.
...
// drops and plants with a bounce, the KEPHA wordmark spreads in.
...
export const KephaSplash: React.FC = () => {
  ...
  const wmTrack = interpolate(frame, [116, 144], [0.72, 0.42], { ...clamp, easing: easeOut });
